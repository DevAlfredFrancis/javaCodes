...
public class DiscountPolicy {
    ...
    public static void main(String[] args) {
        ...
        double totalPurchase, totalDiscount, discountedTotal, salesTax, totalVal; //input
        ...
        if(totalPurchase >= 100 && confirmMusicTeacher.equalsIgnoreCase("yes")) { //12% discount if total purchase is 100 or higher, and customer is a music teacher
            ...
            System.out.println("-------------------------------------");
        }else if(totalPurchase < 100 && confirmMusicTeacher.equalsIgnoreCase("yes")) { //10% discount if total purchase below 100, and customer is a music teacher
